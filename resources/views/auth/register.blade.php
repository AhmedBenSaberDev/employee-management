							...
							<form method="POST" action="{{ route('register') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
                                        ...
                                        <x-jet-input id="name" class="form-control pl-15 bg-transparent text-white plc-white" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Full Name" />
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
                                        ...
                                        <x-jet-input id="email" class="form-control pl-15 bg-transparent text-white plc-white" type="email" name="email" :value="old('email')" required placeholder="Email" />
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
                                        ...
                                        <x-jet-input id="password" class="form-control pl-15 bg-transparent text-white plc-white" type="password" name="password" required autocomplete="new-password" placeholder="Password" />
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
                                        ...
                                        <x-jet-input id="password_confirmation" class="form-control pl-15 bg-transparent text-white plc-white" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Retype Password" />
									</div>
								</div>
								  <div class="row">
									<div class="col-12">
